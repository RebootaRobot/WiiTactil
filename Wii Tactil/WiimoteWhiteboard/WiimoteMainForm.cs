...
namespace WiimoteWhiteboard
{
	public partial class WiimoteMainForm : Form
	{
        ...
        void UpdateTrackingUtilization(PointF[] src)
        {
            ...
            srcscaled[2] = tmp;
            TrackingLayout.Clear(Color.Black);
            TrackingLayout.DrawPolygon(Pens.Red, srcscaled);
            TrackingLayout.FillPolygon(Brushes.Red, srcscaled);
            ...
            pth.AddString(value, new FontFamily("Arial"), 0, 20,
            ...
            TrackingLayout.FillPath(Brushes.White, pth);
            p.Dispose();
            pth.Dispose();
